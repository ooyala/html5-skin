  ...
  render: function() {
    ...
    return (
      React.createElement("ul", {className: "oo-popover-horizontal"}, 
        ...
        React.createElement("li", null, 
          React.createElement("a", {className: "oo-more-captions", onClick: this.handleMoreCaptions}, captionBtnText, " ", React.createElement(Icon, React.__spread({},  this.props, {icon: "arrowRight", className: this.props.className})))
        ), 
        React.createElement("li", null, 
...
},{"../../constants/constants":36,"../closeButton":4,"../icon":22,"../utils":34,"./onOffSwitch":13,"react":213}],9:[function(require,module,exports){
var React = require('react'),
    Utils = require('../utils'),
    CONSTANTS = require('../../constants/constants'),
    SelectionContainer = require('./selectionContainer'),
    ...
    var controlItemTemplates = {
      ...
      "closedCaption": (
        React.createElement("div", {className: "oo-popover-button-container", key: "closedCaption"}, 
          React.createElement("div", {className: "oo-cc-wrapper"}, 
            closedCaptionPopover, 
            React.createElement(Icon, React.__spread({},  this.props, {icon: "cc", style: dynamicStyles.iconCharacter, onClick: this.handleClosedCaptionClick}))
          )
        )
      ),
...
OO.plugin("Html5Skin", function (OO, _, $, W) {
  ...
  if (OO.publicApi && OO.publicApi.VERSION) {
    ...
    OO.publicApi.VERSION.skin = {"releaseVersion": "4.8.5", "rev": "2e95605d6f7701d17a6df0389daaaef7a4211d6e"};
  }
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {className: "oo-state-screen oo-pause-screen"}, 
        ...
        React.createElement("a", {ngIf: "!this.isMobile", className: actionIconClass, onClick: this.handleClick}, 
          React.createElement(Icon, React.__spread({},  this.props, {icon: "pause", style: actionIconStyle}))
        ), 
