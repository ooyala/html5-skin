...
var SharePanel = React.createClass({
    ...
    if (this.state.activeTab === this.tabs.SHARE) {
      ...
      return (
        <div className="shareTabPanel" style={shareScreenStyle.panelStyle}>
          ...
          <div className="twitter" onClick={this.handleTwitterClick} style={twitterIconStyle}>t</div>
          <div className="facebook" onClick={this.handleFacebookClick} style={facebookIconStyle}>f</div>
          <div className="googlePlus" onClick={this.handleGPlusClick} style={plusIconStyle}>g+</div><br/>
          ...
          <table style={{color: "white"}}>
            ...
            <tr>
              ...
              <td style={{textAlign: "right"}}>
                <button className="emailSendButton" onClick={this.handleEmailClick} style={shareScreenStyle.emailSendButton}>Send</button></td>
            </tr>
          </table>
        </div>
      );
  ...
  render: function() {
    ...
    return (
      <div className="sharePanel" style={shareScreenStyle.containerStyle}>
