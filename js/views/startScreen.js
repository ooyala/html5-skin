...
let StartScreen = createReactClass({
  mixins: [ResizeMixin],
  ...
  handleResize: function(nextProps) {
    let description = nextProps ? nextProps.contentTree.description : this.props.contentTree.description;
  ...
  render: function() {
    ...
    let posterImageUrl = this.props.skinConfig.startScreen.showPromo
    ...
    let stateScreenPosterClass = ClassNames({
    ...
    let iconName = this.props.controller.state.playerState === CONSTANTS.STATE.END ? 'replay' : 'play';
