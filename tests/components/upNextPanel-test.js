...
describe('UpNextPanel', function() {
  it('tests up next panel', function() {
    const props = {
      upNextInfo: {
        upNextData: {
          provider_id: 69468,
          name: 'owl',
          description:'owl video',
          status: 'live',
          size:742937,
          updated_at:'2015-11-03 18:13:34 +0000',
          created_at:'2015-05-19 20:56:21 +0000',
          processing_progress:1,
          preview:'1',
          content_type:'Video',
          language:'en',
          duration:6066,
          preview_image_url:'http://cf.c.ooyala.com/o2Ymc2dTpIcimIbgA4eI6oSWbrpyFPhA/promo256337880',
    ...
    var wrapper = Enzyme.mount(<UpNextPanel {...props}/>);
