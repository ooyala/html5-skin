    ...
    var skinConfig2 = {
      localization: {
        ...
        availableLanguageFile: [
          {
            'language': 'en',
            'languageFile': '//player.ooyala.com/static/v4/stable/4.24.9/skin-plugin/en.json',
            'androidResource': 'skin-config/en.json',
            'iosResource': 'en'
          },
          {
            'language': 'es',
            'languageFile': '//player.ooyala.com/static/v4/stable/4.24.9/skin-plugin/es.json',
            'androidResource': 'skin-config/es.json',
            'iosResource': 'es'
          },
          {
            'language': 'zh',
            'languageFile': '//player.ooyala.com/static/v4/stable/4.24.9/skin-plugin/zh.json',
